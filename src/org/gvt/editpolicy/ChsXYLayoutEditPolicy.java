...
import org.gvt.command.CloneCommand;
...
public class ChsXYLayoutEditPolicy extends XYLayoutEditPolicy
{
	...
	protected Command getCloneCommand(ChangeBoundsRequest request)
	{
		...
		clone.setParent((CompoundModel)getHost().getModel());

		Iterator i = request.getEditParts().iterator();
		GraphicalEditPart currPart;

		while (i.hasNext())
		{
			currPart = (GraphicalEditPart)i.next();
			clone.addPart((GraphObject)currPart.getModel(),
